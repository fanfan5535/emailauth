...
header("location:readmail.php?id=$id");
}
else
{
echo "<script>alert('Verification Unsuccess Wrong Key..');</script>";
}
}
        ...
        <!-- /.col -->
		 ...
		 <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Mail Read Key </h3>
			  ...
			  <form method="post" name="form1">
			    <table width="90%" border="0">
                  ...
                  <tr>
                    <td height="33">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>Enter Key in reverse order </td>
                    <td><label>
