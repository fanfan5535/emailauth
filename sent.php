            ...
            <div class="box-body no-padding">
			  ...
			  <form method="post" name="form1">
                <table class="table table-hover table-striped">
                  <tbody>
				  <?php
				  $qry=mysql_query("select * from sentmail where sid='$id' ORDER BY id DESC");
				  while($row=mysql_fetch_array($qry))
				  {
				  ?>
                  <tr>
                   <td class="mailbox-name"><a href="readmail.php?id=<?php echo $row['rid'];?>"><?php echo $row['recivername'];?></a></td>
					...
					$img='<img src="img/1.png" height="20" width="20"/>';
					}
					if($s==1)
					{
					$img='<img src="img/2.png" height="20" width="20"/>';
					}
					?>
					
					 <td class="mailbox-subject"><?php echo $img;?></td>
