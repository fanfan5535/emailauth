...
$nm=$rt['name'];
 $im=$rt['image'];
$q=mysql_query("update sentmail set rstatus='1' where id='$id'");
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="box-body no-padding">
			  ...
			  <form method="post" name="form1">
                <table class="table table-hover table-striped">
                  <tbody>
				  <?php
				  $qry=mysql_query("select * from sentmail where id='$id'");
				  while($row=mysql_fetch_array($qry))
				  { 
				  ?>
                  <tr>
                    <td width="8%">Subject:</td>
                    <td width="66%"><?php echo $row['subject'];?></td>
                    <td width="13%"></td>
                    <td width="13%"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>File Details:</td>
                    <td><?php echo $row['file'];?><br/><?php echo $row['type'];?><br/><?php echo $row['size'];?></td>
                    <td></td>
                    <td></td>
                  </tr>
                  <tr>
                    ...
                    <td><table width="50%" border="0" align="center">
                      <tr>
                        <td colspan="2"><div align="center"><?php echo $row['file'];?></div>
                          </td>
                        </tr>
                      
                      <tr>
                        <td width="41%">&nbsp;</td>
                        <td width="59%"><a href="download.php?id=<?php echo $row['file'];?>">Download</a></td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
