...
$email=$_SESSION['uname'];
 $qr=mysql_query("select * from register where email='$email'");
 $rq=mysql_fetch_array($qr);
 $id=$rq['id'];
 $name=$rq['name'];
 $nm=$rq['name'];
 $im=$rq['image'];
...
$q=mysql_query("update register set image='$fname' where id='$id'");
if($q)
{
            ...
            <div class="box-body no-padding">
			  ...
			  <form method="post" enctype="multipart/form-data" name="form1">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    <td width="10%">Name</td>
                    <td width="64%"><?php echo $row['name'];?></td>
                    <td width="13%"></td>
                    <td width="13%"></td>
                  </tr>
                  <tr>
